...
/*
RECEIVE DATA FROM PI: obj_num_g, degrees_g (call in outside function ex. printPi)
-two bytes received:
ex.
 1111 1111 | 1111 1111
b15         b7       b0
...
//Final variables: 
//1. obj_num_g , 2. degrees_g ;
//1. object detected number 2. degree turn for water sprayer (0-180) 
...
// @CARLOS: Refer obj_num_g to corresp. name of object commented up above 
  printPi(degrees_g, obj_num_g);
  Serial.print("\n");
  } 
}


void printPi( volatile unsigned int& degr, volatile unsigned int& obj_num_g)
{
  //IMP:
